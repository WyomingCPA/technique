...
class GetDataTv40 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:get-data-tv-40';
    ...
    public function handle()
    {
        ...
        for ($i = 1; $i <= $page; $i++) {
            ...
            $response = $client->request('GET', 'https://www.techprom.ru/catalog/televizory_i_razvlecheniya/televizory/televizory_39_43_99sm_109sm/?arrFilter_P9_MIN=&arrFilter_P9_MAX=&arrFilter_9437=3182748561&stock=1&set_filter=%D0%9F%D0%BE%D0%BA%D0%B0%D0%B7%D0%B0%D1%82%D1%8C&PAGEN_1=' . $i)->getBody()->getContents();
        ...
        $products = Product::where('category_id', 4)->where('city', 'kor')->get();
