...
class GetDataSmartphones extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:get-data-smart-phones';
    ...
    public function handle()
    {
        ...
        for ($i = 1; $i <= $page; $i++) {
            ...
            $response = $client->request('GET', 'https://www.techprom.ru/catalog/smartfony_planshety_i_gadzhety/smartfony_i_gadzhety/smartfony/?arrFilter_P9_MIN=&arrFilter_P9_MAX=&arrFilter_9437=3182748561&stock=1&set_filter=%D0%9F%D0%BE%D0%BA%D0%B0%D0%B7%D0%B0%D1%82%D1%8C&PAGEN_1=' . $i)->getBody()->getContents();
        ...
        $products = Product::where('category_id', 7)->where('city', 'kor')->get();
