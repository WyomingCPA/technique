...
class GetDataWashMasine extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:get-data-washmashine-kot';
    ...
    public function handle()
    {
        ...
        for ($i = 1; $i <= $page; $i++) {
            ...
            $response = $client->request('GET', 'https://www.techprom.ru/catalog/bytovaya_tekhnika_i_tovary_dlya_doma/krupnaya_bytovaya_tekhnika/stiralnye_mashiny/?stock=1&arrFilter_P9_MIN=&arrFilter_P9_MAX=&arrFilter_9437=2526654546&arrFilter_6430_MIN=&arrFilter_6430_MAX=&set_filter=%D0%9F%D0%BE%D0%BA%D0%B0%D0%B7%D0%B0%D1%82%D1%8C&PAGEN_1=' . $i)->getBody()->getContents();
        ...
        $products = Product::where('category_id', 2)->where('city', 'kot')->get();
